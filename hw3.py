...
N = abs(int(input('Введите 1, если играем в английской раскладке, если в русской то 0: ')))
word = input('Введите слово: ').upper()
if N == 1:
	print('Ваше слово', word,'. За него вы получаете', sum([k for i in word for k, v in eng.items() if i in v]), 'очков') 
if N == 0:
	print('Ваше слово', word,'. За него вы получаете', sum([k for i in word for k, v in rus.items() if i in v]), 'очков') 
